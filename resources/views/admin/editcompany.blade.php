...
<style type="text/css">
    ...
    <form action="{{ route('editcompanydata') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-row">
<input type="hidden" name="id" value="{{  $company->id }}">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="email" class="form-control" name="email" id="inputEmail4" value="{{ $company->email }}"
                    placeholder="email">
            </div>
        </div>
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="website_url" id="website_url"
                    value="{{ $company->website_url }}" placeholder="website url">
            </div>
            <div class="row col-6">
                ...
                <div class="col-6">
                    <img src="{{ asset('storage/' . $company->logo) }}" width="100" alt="">
                </div>
            </div>
        </div>
        </div>
